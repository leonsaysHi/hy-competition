    ...
    <template v-else>
      ...
      <template v-if="selectedPhase && selectedGroup">
        ...
        <div class="mb-3 d-flex justify-content-center">
          <ButtonComp variant="primary" class="text-white" size="lg" :to="{ name: 'competition-games' }">Ver Resultados</ButtonComp>
        </div>
        <hr />
        <h3>{{ t('global.standing') }}</h3>
        <CompetitionStanding :value="selectedGroup.standing" :length="7" />
        <div class="mb-3 d-flex justify-content-center">
          <ButtonComp variant="primary" class="text-white" size="lg" :to="{ name: 'competition-standing' }">Ver tabla completa</ButtonComp>
        </div>
      </template>
    </template>
  </div>
